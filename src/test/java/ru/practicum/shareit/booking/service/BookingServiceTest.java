...
public class BookingServiceTest {
    ...
    void  addBookingItemBooked() {
        ...
        assertThrows(NotValidException.class, () -> bookingService.addBooking(bookingDto, anyLong()));
    }
    ...
    void  approveBookingWrongStatus() {
        ...
        assertThrows(NotValidException.class, () -> bookingService.approveBooking(firstUser.getId(), item.getId(), true));
    }
    ...
    void getAllBookingsByBookerId() {
        ...
        when(bookingRepository.findAllByBookerIdAndStartBeforeAndEndAfterOrderByStartDesc(anyLong(), any(LocalDateTime.class), any(LocalDateTime.class), any(PageRequest.class))).thenReturn(new PageImpl<>(List.of(firstBooking)));
        state = "CURRENT";
    ...
    void getAllBookingsForAllItemsByOwnerIdNotHaveItems() {
        ...
        assertThrows(NotValidException.class, () -> bookingService.getAllBookingsForAllItemsByOwnerId(firstUser.getId(), "APPROVED", 5, 10));
    }
}

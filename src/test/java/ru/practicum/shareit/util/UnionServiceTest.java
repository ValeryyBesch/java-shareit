...
public class UnionServiceTest {
    ...
    @Test
    void checkPageSize() {
        assertThrows(NotValidException.class, () -> unionService.checkPageSize(0,0));
        assertThrows(NotValidException.class, () -> unionService.checkPageSize(5,-5));
        assertThrows(NotValidException.class, () -> unionService.checkPageSize(5,0));
        assertThrows(NotValidException.class, () -> unionService.checkPageSize(-5,5));
    }
}